      ...
      <View style={styles.container}>
        <View style={styles.card}>
          ...
          <View style={{ width: "100%" }}>
            <Text style={{ color: "black", fontSize: 14, fontWeight: 600, fontFamily: "PlusJakartaSans", marginBottom: 8 }}> Konfirmasi Kata Sandi </Text>
            <PasswordInput />
          </View>
          <TouchableOpacity style={styles.button}>
            <Text style={{ color: primaryColor, fontFamily: "PlusJakartaSans", fontSize: 24, fontWeight: "bold" }}>Daftar</Text>
          </TouchableOpacity>
          <View style={{ width: "100%", marginVertical: 26 }}>
            ...
            <Text style={{ fontSize: 14, color: primaryColor, fontFamily: "PlusJakartaSans", textAlign: "center", marginTop: 20, fontWeight: "400" }}>
              Sudah Punya Akun?{" "}
              <Link href={"/auth/signin"} style={{ fontWeight: "bold", textDecorationLine: "underline" }}>
                Masuk
              </Link>
            </Text>
          </View>
